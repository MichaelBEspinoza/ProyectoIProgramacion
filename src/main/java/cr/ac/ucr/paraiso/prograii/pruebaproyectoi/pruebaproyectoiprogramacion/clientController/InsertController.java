...
public class InsertController {
    ...
    public void insertOnAction(ActionEvent actionEvent) {
        try {
            ...
            DesignPattern designPatternUsed = new DesignPattern(designPattern.generatePatternCode(),nameArea.getText(),contextArea.getText(),clasificationArea.getText(),exampleArea.getText(),contextArea.getText(),problemArea.getText(),solutionArea.getText(),datePicker.getValue());
            ...
            client.insertar(designPatternUsed);
